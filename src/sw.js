...
workbox.routing.registerRoute(/https:\/\/kokodayo.fun\//, new workbox.strategies.StaleWhileRevalidate({ plugins: [new workbox.cacheableResponse.Plugin({ statuses: [0, 200] })] }), 'GET');
