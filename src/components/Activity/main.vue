  ...
  <div>
    <div class="activity-wrapper">
      ...
      <div style="margin-top: 20px">
        <span class="activity-info-need">Logo换新</span>
      </div>
      <div style="margin-top: 20px">
        ...
        <p class="activity-info-need">
          <span
            >2021 1/20 近期计划:<del>开始改版 </del> 预计有两个新功能,
            准备建文件夹了！</span
          >
        </p>
        <p class="activity-info-need">1. 希望有人能帮忙重新设计下pc版</p>
        <p class="activity-info-need">2. 小程序开发中...</p>
        <p class="activity-info-need">
          3. 地图更换渲染引擎以获取更好的展现效果和性能
        </p>
      </div>
      <div style="margin-top: 20px">
...
export default {
  ...
  data() {
    return {
      activityPic: require('./img/anniversary.jpg')
    }
  }
}
</script>
